...
class Game():
    def __init__(self):
        ...
        self.fuente_3 = 'fuentes/TypoSlab Irregular Demo.otf'
    ...
    def bucle_juego(self):
        ...
        while self.jugar:
            ...
            self.pintar_record("Aliens restantes: ", 20, 650, 550, self.player.alien_muertos)
            self.pintar_record("Items restantes: ", 20, 650, 570, self.player.items)
